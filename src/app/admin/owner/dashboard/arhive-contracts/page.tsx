...
function ContractsPage() {
  ...
  const filteredArhive = sortedContracts.filter((contract: any) => contract.status === "COMPLETED")

  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">Arhive</h1>
      ...
      <DataTable columns={columns} data={filteredArhive} />
